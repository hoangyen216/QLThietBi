<template>
    ...
    <el-card shadow="never" style="height: 100vh">
        ...
        <el-pagination style=" bottom: 2px; position: absolute;" v-model:current-page="page"
            v-model:page-size="pageSize"  :background=true layout=" prev, pager, next"
            :total="total" />
    </el-card>
    <el-dialog v-model="dialogAddCategory" title="Thêm mới loại hàng" width="500">
        <el-form>
...
const { data } = useFetchApi('/item/getall', {
    method: 'GET',
    query: {
        page: page,
        pageSize: pageSize,
